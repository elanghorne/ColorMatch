...
func determineHarmony(from buckets: inout [ColorBucket]) -> Bool {
    ...
    if buckets.count == 1 {
        ...
        if buckets[0].label.1 == "Neutral" || buckets[1].label.1 == "Neutral" {
            ...
            return twoBucketAnalysis(on: buckets)
        }
        ...
        if buckets[0].label.1 == "Neutral" || buckets[1].label.1 == "Neutral" || buckets[2].label.1 == "Neutral" {
            ...
            return threeBucketAnalysis(on: buckets)
        }
